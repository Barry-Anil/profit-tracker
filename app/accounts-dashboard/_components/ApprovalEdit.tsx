                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel>
                                                        Charge Date - <span className="text-red-400">{formattedDate(row?.row.original.accounts_chargedate)}</span>
                                                    </FormLabel>
                                                    <FormControl>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={field.onChange} defaultValue={row?.row.original?.accounts_payment_approval}>
                                                        <FormControl>
                                                            <SelectTrigger>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel>
                                                        Approval Date - <span className="text-red-400">{formattedDate(row?.row.original?.acc_approval_eta)}</span>
                                                    </FormLabel>
                                                    <FormControl>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel>
                                                        Fabric Date - <span className="text-red-500">{formattedDate(row?.row.original?.accounts_payment_approval)}</span>{' '}
                                                    </FormLabel>
                                                    <FormControl>
                                                        <Input type="date" {...field} />
                                                    </FormControl>
